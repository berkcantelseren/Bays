...
export default function HowItWorks() {
  return (
    <div className="flex bg-[#1E1E1E] w-[90%] justify-center items-center mx-auto h-full md:h-[542px] rounded-2xl border border-[#3D3D3F] mt-90 md:mt-30 lg:mt-90">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-40">
        {/* Grid Item 1 */}
        <div className="w-[260] h-[260] md:w-[460] md:h-[360] flex flex-col justify-start ml-0 md:ml-30 lg:ml-0">
        ...
        {/* Grid Item 2 */}
        <div className="bg-[#1F1F1F] gradient-custom w-[316] h-[260] md:w-[516] md:h-[398] mt-35 mb-20 md:mt-0 md:mb-0 justify-center items-center align-center rounded-2xl border border-[#3D3D3F] sm:flex md:hidden lg:flex">
          <Image
            src="images/step.svg"
            alt="step icon"
            width={450}
